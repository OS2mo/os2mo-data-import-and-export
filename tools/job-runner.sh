...
exports_actual_state_export(){
    ...
    ${POETRYPATH} run python exporters/sql_export/sql_export.py --resolve-dar
    EXIT_CODE=$?
    return $EXIT_CODE
}
...
exports_historic_sql_export(){
    ...
    ${POETRYPATH} run python exporters/sql_export/sql_export.py --resolve-dar --historic
    EXIT_CODE=$?
    return $EXIT_CODE
}
...
exports_lc_for_jobs_db(){
    ...
    ${POETRYPATH} run python exporters/sql_export/lc_for_jobs_db.py sql-export --resolve-dar
    local STATUS=$?
...
exports_cache_loracache() {
    ...
    ${POETRYPATH} run python exporters/sql_export/lora_cache.py --no-historic --resolve-dar
    EXIT_CODE=$?
    return $EXIT_CODE
}
...
exports_historic_cache_loracache() {
    ...
    ${POETRYPATH} run python exporters/sql_export/lora_cache.py --historic --resolve-dar
    EXIT_CODE=$?
    return $EXIT_CODE
}
...
exports_historic_skip_past_cache_loracache() {
    ...
    ${POETRYPATH} run python exporters/sql_export/lora_cache.py --historic --skip-past --resolve-dar
    EXIT_CODE=$?
    return $EXIT_CODE
}
