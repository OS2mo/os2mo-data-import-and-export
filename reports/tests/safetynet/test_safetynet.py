...
@patch("reports.safetynet.safetynet.get_mo_client")
def test_adm_engagements_sd_ou_manager_the_same_as_eng_employee_use_parent_manager(
    mock_get_mo_client: MagicMock,
    sd_ou_manager_the_same_as_eng_employee,
    engagements,
    sd_ou_parent_manager: dict[str, Any],
) -> None:
    # Arrange
...
@patch("reports.safetynet.safetynet.get_unified_settings")
@patch("reports.safetynet.safetynet.get_mo_client")
def test_csv_adm_engagements_sd_ou_manager_the_same_as_eng_employee(
    mock_get_mo_client: MagicMock,
    mock_get_unified_settings: MagicMock,
    sd_ou_manager_the_same_as_eng_employee,
    engagements,
...
def test_adm_engagements_sd_ou_manager_cpr_included(
    ...
    assert csv_lines == [
        ...
        "12345||0101011255||Bruce||Lee||bruce@kung.fu||9d1af806-f4d6-44e2-a001-a5deb3aa6703||2021-10-22||2025-09-30||54321||2010014321||bruce||Kung Fu Master||Kung Fu Master\n",
    ]


@patch("reports.safetynet.safetynet.get_unified_settings")
@patch("reports.safetynet.safetynet.get_mo_client")
def test_adm_engagements_sd_ou_manager_the_same_as_eng_employee_cpr_incl(
    mock_get_mo_client: MagicMock,
    mock_get_unified_settings: MagicMock,
    sd_ou_manager_the_same_as_eng_employee,
    engagements,
