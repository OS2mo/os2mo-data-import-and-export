...
class OPUSPrimaryEngagementUpdater(MOPrimaryEngagementUpdater):
    ...
    def __init__(self):
        ...
        self.eng_types_order = self.settings['integrations.opus.eng_types_primary_order']

        def engagements_included_in_primary_calculation(self, engagement):
            if eng["org_unit"]["uuid"] in self.settings.get("integrations.ad.import_ou.mo_unit_uuid", ""):
