...
class KleImporter(object):
    ...
    def import_kle(self):
        ...
        kle_number_uuid = self.get_or_create_facet('kle_number')
        self._import_emne(kle_number_uuid, kle_number_uuid, kle_number_uuid)
        self._import_handling(kle_number_uuid, kle_number_uuid)

        kle_hoved_uuid = self.get_or_create_facet('kle_hovedgruppe')
        kle_gruppe_uuid = self.get_or_create_facet('kle_gruppe')
        kle_emne_uuid = self.get_or_create_facet('kle_emne')
        self._import_emne(kle_hoved_uuid, kle_gruppe_uuid, kle_emne_uuid)
        self._import_handling(kle_hoved_uuid, kle_gruppe_uuid)
