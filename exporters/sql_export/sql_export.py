...
class SqlExport:
    ...
    def _generate_sql_addresses(
        ...
        return model(
            ...
            adressetype_uuid=address_info["address_type"],
            adressetype_bvn=self.lc.classes[address_info["address_type"]]["user_key"],
            adressetype_scope=self.lc.classes[address_info["address_type"]]["scope"],
            adressetype_titel=self.lc.classes[address_info["address_type"]]["title"],
