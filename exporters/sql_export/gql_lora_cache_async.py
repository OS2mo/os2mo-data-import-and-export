...
class GQLLoraCache:
    ...
    async def _execute_codegen_query(
        ...
        # https://git.magenta.dk/rammearkitektur/FastRAMQPI/-/blob/master/fastramqpi/raclients/graph/util.py?ref_type=heads#L42-99
        cursor = None
        while True:
            for attempt in Retrying(
                ...
                with attempt:
                    result = await query(cursor=cursor, **kwargs)
            ...
            result[str(obj.uuid)] = [
                {
                    ...
                    "to_date": str(o.validity.to.date())
                    if o.validity.to
                    else "9999-12-31",
