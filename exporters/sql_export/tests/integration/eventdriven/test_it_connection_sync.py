...
def expected(uuid: str, it_system_uuid: str, person_uuid: str, brugernavn: str) -> dict:
    return {
        "uuid": uuid,
...
async def test_it_connection_lifecycle(
    server: None,
    ...
    await assert_absent(session, ItForbindelse)
