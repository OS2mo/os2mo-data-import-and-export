...
"""Historic (full-history) export of an IT system.

Mirrors ``test_it_system_sync`` but asserts the historic export DB. An IT
system is hard-deleted, which removes it from both export targets.
"""
...
async def test_it_system_historic_lifecycle(
    server: None,
