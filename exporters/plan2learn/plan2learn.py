...
def get_unified_settings(kubernetes_environment: bool) -> Settings:
    ...
    return Settings(
        ...
        exporters_plan2learn_allowed_engagement_types=settings.exporters.plan2learn.allowed_engagement_types,  # type: ignore
        plan2learn_email_priority=settings.plan2learn_email_priority,  # type: ignore
        plan2learn_phone_priority=settings.plan2learn_phone_priority,  # type: ignore
        exporters_plan2learn_root_unit=settings.exporters_plan2learn_root_unit,  # type: ignore
        integrations_SD_Lon_import_too_deep=settings.integrations_SD_Lon_import_too_deep,  # type: ignore
    )
